package empresa_xyz_distribuciones.Servidor.BD;
...
public class ConexionMySQL {
    ...
    private static final String BD = "flotilla_xyz";
    private static final String URL = "jdbc:mysql://localhost:3306/flotilla_xyz" + BD + "?serverTimezone=UTC&useSSL=false";
